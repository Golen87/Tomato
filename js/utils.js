...
{
	return Global.game.rnd.integerInRange( min, max );
}

function randFloat( min, max )
{
	return Global.game.rnd.realInRange( min, max );
}
...
function tweenTint( obj, startColor, endColor, time )
{
	...
	var colorTween = Global.game.add.tween(colorBlend).to({step: 100}, time);
